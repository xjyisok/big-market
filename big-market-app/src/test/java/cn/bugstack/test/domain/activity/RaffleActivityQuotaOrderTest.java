...
@SpringBootTest
public class RaffleActivityQuotaOrderTest {

    @Resource
    private IRaffleOrderAccountQuoat raffleOrder;
    @Resource
    ...
    public void test_createSkuRechargeOrder_duplicate() {
        ...
        UnpaidActivityOrderEntity unpaidActivityOrderEntity= raffleOrder.createSkuRechargeOrder(skuRechargeEntity);
    ...
    public void test_credit_pay_trade() {
        ...
        skuRechargeEntity.setSku(9011L);
        // outBusinessNo 作为幂等仿重使用，同一个业务单号2次使用会抛出索引冲突 Duplicate entry '700091009111' for key 'uq_out_business_no' 确保唯一性。
        skuRechargeEntity.setOutBusinessNo("70009240614001");
